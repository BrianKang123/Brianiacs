...
public class Woo{
  ...
  public void playTurnAI(Token tok){
    ...
    if(cur == 30){
      System.out.println("Player " + tok.getNumber() + " landed on Go To Jail... (WORK IN PROGRESS)");
    }
    ...
    //4, 12, 28, 38
      ...
      if(tok.getPos() == 4){
        if(tok.getBalance() > 200){
          ...
          System.out.println("Player " + tok.getNumber() + " landed on Income Tax, player " + tok.getNumber() + " must pay $200!");
          System.out.println("Current Balance of player " + tok.getNumber() + ": $" + tok.getBalance());
        }
        else{
      ...
      if(tok.getPos() == 38){
        if(tok.getBalance() > 100){
          ...
          System.out.println("Player " + tok.getNumber() + " landed on Luxury Tax, player " + tok.getNumber() + " must pay $100!");
          System.out.println("Current Balance of player " + tok.getNumber() + ": $" + tok.getBalance());
        }
        else{
          System.out.println("Player " + tok.getNumber() + " didn't have enough money to pay the tax!");
  ...
  public void playTurn(Token tok){
    ...
    if(board[tok.getPos()] instanceof Property){
      ...
      //If the Token lands on an owned property that is theirs
        ...
        System.out.println("You landed on " + currentProperty.getName() + ", property that you own. There is no need to do anything this turn.");
      }
      //If the Token lands on an owned property that is NOT theirs
      else{
